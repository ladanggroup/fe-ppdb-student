    ...
    <div className="overflow-y-auto">
      ...
      <section className="text-center py-16 bg-orange-50">
        ...
        <div className="mt-6 space-x-4">
          <Link
            to="/daftar"
            className="px-6 py-2 bg-orange-soft hover:bg-white hover:text-orange-soft-700 hover:border-orange-soft-700 text-white rounded-lg"
          >
            Daftar Sekarang
          </Link>
          <Link
      ...
      <section className="py-16 max-w-7xl mx-auto px-4">
        <h2 className="text-center text-2xl md:text-3xl font-bold mb-4">
          Sekolah Telah <span className="text-orange-500">Membuktikannya</span>
        </h2>
      ...
      <section className="py-16 bg-gray-50 max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <Link to="/faq" className="bg-orange-soft text-white hover:bg-white hover:text-orange-soft-800 px-4 py-2 rounded-xl">
              Hubungi Kami
            </Link>
          </div>
          <div>
